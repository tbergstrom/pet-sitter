...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http, AuthenticationConfiguration authConfig) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.GET, "/api", "/api/pets", "/api/pets/pet/*", "/api/pets/*", "/api/pets/mypets", "/api/contact-info", "/api/contact-info/user/my-info","/api/contact-info/*", "/api/visit/singlevisit/*", "/api/users/all-owners", "/api/users/all-sitters", "api/users/sitter/*", "api/users/owner/*").hasAnyAuthority("OWNER", "SITTER")
